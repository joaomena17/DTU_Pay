Feature: ReportFeature
  ...
  Scenario: Add payment to repository
    Given there is an unregistered payment of 10 kr with customer "cid1" and merchant "mid1" with token "tok1"
    When a "RequestPaymentCompleted" event is received to complete a payment
    Then the payment of 10 kr from "cid1" to "mid1" with token "tok1" is added to the repository

  Scenario: Return customer report
    Given there is a registered payment of 20 kr with customer "cid2" and merchant "mid2" with token "tok2"
  ...
  Scenario: Return merchant report
    Given there is a registered payment of 30 kr with customer "cid3" and merchant "mid3" with token "tok3"
  ...
  Scenario: Return manager report
    Given there is a registered payment of 40 kr with customer "cid4" and merchant "mid4" with token "tok4"
    And there is a registered payment of 50 kr with customer "cid5" and merchant "mid5" with token "tok5"
